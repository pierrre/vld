...
func ExampleSeqEach() {
	...
	fmt.Println(GetErrorLocalization(vr.Validate(slices.Values([]int{2})), "en"))
	// Output:
...
func ExampleSeq2Each() {
	...
	fmt.Println(GetErrorLocalization(vr.Validate(slices.All([]int{2})), "en"))
	// Output:
...
func ExampleSeq2EachKey() {
	...
	fmt.Println(GetErrorLocalization(vr.Validate(slices.All([]int{1, 1})), "en"))
	// Output:
	// Seq2EachKey(Equal(0))
	// <nil>
