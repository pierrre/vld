...
func (vr *IfValidator[T]) Localize(locales ...string) string {
	...
	sb.WriteString(Localize("IfValidator", []any{getFuncName(vr.Condition)}, locales...))
	sb.WriteString("\n")
...
func (vr *IfElseValidator[T]) Localize(locales ...string) string {
	sb := new(strings.Builder)
	sb.WriteString(Localize("IfElseValidator", []any{getFuncName(vr.Condition)}, locales...))
	sb.WriteString("\n")
...
func (sv *SwitchValidator[T]) Localize(locales ...string) string {
	sb := new(strings.Builder)
	sb.WriteString(Localize("SwitchValidator", nil, locales...))
	for _, c := range sv.Cases {
		sb.WriteString("\n")
