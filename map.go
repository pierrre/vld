...
func MapEachKey[M ~map[K]V, K comparable, V any](vr Validator[K]) Validator[M] {
	return WithStringFunc(func() string { return fmt.Sprintf("MapEachKey(%v)", vr) }, mapEach[M](field("key", KeyValue[K, V].GetKey, vr.Validate)))
}
...
func MapEachValue[M ~map[K]V, K comparable, V any](vr Validator[V]) Validator[M] {
	return WithStringFunc(func() string { return fmt.Sprintf("MapEachValue(%v)", vr) }, mapEach[M](field("value", KeyValue[K, V].GetValue, vr.Validate)))
}
...
func MapSortedEachKey[M ~map[K]V, K cmp.Ordered, V any](vr Validator[K]) Validator[M] {
	return WithStringFunc(func() string { return fmt.Sprintf("MapSortedEachKey(%v)", vr) }, mapSortedEach[M](field("key", KeyValue[K, V].GetKey, vr.Validate)))
}
...
func MapSortedEachValue[M ~map[K]V, K cmp.Ordered, V any](vr Validator[V]) Validator[M] {
	return WithStringFunc(func() string { return fmt.Sprintf("MapSortedEachValue(%v)", vr) }, mapSortedEach[M](field("value", KeyValue[K, V].GetValue, vr.Validate)))
}
