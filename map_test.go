...
func ExampleMapEach() {
	...
	// Each key/value of the map must satisfy the following validator: Value must be equal to vld.KeyValue[string,int]{Key:"a", Value:1}.
	// <nil>
...
func ExampleMapEachKey() {
	...
	// Output:
	// MapEachKey(Equal("a"))
	// Each key of the map must satisfy the following validator: Value must be equal to "a".
	// <nil>
...
func ExampleMapEachValue() {
	...
	// Each value of the map must satisfy the following validator: Value must be equal to 1.
	// <nil>
